...
Variable *variableList[] = {
    ...
    new BoschBME280_Pressure(&bme280, "e16ae034-1b5b-4fbe-87d1-4875b4ba07cf"),
    new BoschBME280_Altitude(&bme280, "5efa56c9-6604-4606-bb56-140c0ee73416"),
    ...
    new ProcessorStats_Batt(&mayfly, "05458ff1-0f46-4cc1-a04a-a0e2d208064d"),
    new MaximDS3231_Temp(&ds3231, "73615068-83a4-42dd-99cd-9368986d7fad"),
...
// ==========================================================================
const char *registrationToken = "fa5d2105-6b3c-4cd4-8715-71c5ae3e6e7a";   // Device registration token
const char *samplingFeature = "a8953b9e-bd86-4ec6-93f6-c5ba54e3c991";     // Sampling feature UUID
